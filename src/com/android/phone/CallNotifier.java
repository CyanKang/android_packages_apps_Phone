...
public class CallNotifier extends Handler
    ...
    private void showBlacklistNotification(Context ctx, String number) {
        ...
        // Add the 'Remove block' notification action
